  ...
  const cactus = new Image(tWidth,tWidth);
  cactus.src = "./images/cactus.png"
  const roses = new Image(tWidth,tWidth);
  roses.src = "./images/roses.png"
  const violets = new Image(tWidth,tWidth);
  violets.src = "./images/violets.png"
  const root1 = new Image(tWidth,tWidth);
  root1.src = "./images/root1.png"
  const root2 = new Image(tWidth,tWidth);
  root2.src = "./images/root2.png"
  const root3 = new Image(tWidth,tWidth);
  root3.src = "./images/root3.png"
  const root4 = new Image(tWidth,tWidth);
  root4.src = "./images/root4.png"
  const root5 = new Image(tWidth,tWidth);
